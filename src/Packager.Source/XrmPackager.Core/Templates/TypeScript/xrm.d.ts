declare namespace Xrm {
  ...
  */
  ...
  /**
   * Default quick view form collection shape for forms without named quick view controls.
   */
  interface QuickViewFormsBase extends QuickViewFormCollectionBase {
    get(name: string): undefined;
    get(): QuickViewFormBase[];
    get(index: number): QuickViewFormBase;
    get(chooser: (item: QuickViewFormBase, index: number) => boolean): QuickViewFormBase[];
  }
...
declare namespace Xrm {
    ...
    interface AppSidePane extends SidePaneProperties {
         ...
         */
         navigate(pageInput: EntityRecord | EntityList | WebResource | Dashboard | Control): Promise<undefined>;
    }
